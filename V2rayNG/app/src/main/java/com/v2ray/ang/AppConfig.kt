...
object AppConfig {
    ...
    // fork-only: outage ticker / remote config cache
    ...
    const val PREF_FORK_IRAN_GEO_PROMPTED = "pref_fork_iran_geo_prompted"
    ...
    const val APP_URL = "$GITHUB_URL/vatandev/v2rayNG-Pro"
    const val UPSTREAM_VERSION = "2.1.7"
    const val APP_API_URL = "https://api.github.com/repos/vatandev/v2rayNG-Pro/releases"
